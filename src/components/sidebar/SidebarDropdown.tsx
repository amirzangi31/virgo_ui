...
const SidebarItemVariants: SidebarItemVariantsFunction = cva(
      "flex justify-between items-center gap-2 relative  py-2 after:absolute after:bottom-0  after:right-1/2 after:w-0 after:h-[2px] after:bg-primary after:block hover:after:w-full hover:after:right-0 after:rounded-xl after:transition-all after:duration-500 cursor-pointer hover:text-primary transition-color duration-300",
      {
            variants: {
                  isOpen: {
